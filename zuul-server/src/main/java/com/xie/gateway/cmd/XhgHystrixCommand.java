...
//import com.xhg.core.constant.AppStatic;
//import com.xhg.core.web.DataHolder;
//import com.xhg.core.web.exception.BusinessException;
//import com.xhg.core.web.exception.VitalBusinessException;
...
// * @author xie
// */
//public class XhgHystrixCommand extends HystrixCommand<Object> {
//
//    final static ConcurrentHashMap<String, Boolean> serverStatus = new ConcurrentHashMap<String, Boolean>();
//
//    private Logger logger = LoggerFactory.getLogger(XhgHystrixCommand.class);
//
...
//
//
//    public XhgHystrixCommand(RequestMappingInfo mappingInfo, Object target, Object[] args,
